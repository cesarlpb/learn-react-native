...
"plugins": [
    [
        "react-native-auth0",
        {
            "domain": "dev-e5upauw63vg8bv3m.us.auth0.com"
...
Replace `dev-e5upauw63vg8bv3m.us.auth0.com` with your Auth0 domain value. If you have `samples.auth0.com` as your Auth0 domain you would have a configuration like the following:
